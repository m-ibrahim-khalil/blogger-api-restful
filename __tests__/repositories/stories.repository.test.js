...
describe('Testing Stories Repository: ', () => {
  ...
  describe('Testing Create Story function: ', () => {
    it('should create an Story and return a Story body: ', async () => {
      ...
      const authorId = '1234';
      const coverImageURL = 'https://www.google.com';
      const expectedStory = { title, description, coverImageURL, authorId };
      jest
        .spyOn(Story, 'create')
    ...
    it('should throw an error if there is an error in the database query', async () => {
      ...
      await expect(
        StoriesRepository.create(title, description, coverImageURL, authorId)
      ).rejects.toThrow(expectedError);
    });
  });
  ...
  describe('Testing updateById function: ', () => {
    ...
    it('should throw an error if there is an error in the database query', async () => {
      ...
      await expect(
        StoriesRepository.updateById(id, title, description)
      ).rejects.toThrow(expectedError);
    });
  });

  describe('Testing deleteById function: ', () => {
    ...
    it('should throw an error if there is an error in the database query', async () => {
      ...
      await expect(StoriesRepository.deleteById(id)).rejects.toThrow(
        expectedError
      );
    });
  });
